 ...
 */
@RestController
@RequestMapping("mymallmember/umsmemberreceiveaddress")
public class UmsMemberReceiveAddressController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("mymallmember:umsmemberreceiveaddress:list")
   ...
   // @RequiresPermissions("mymallmember:umsmemberreceiveaddress:info")
     ...
     */
    @RequestMapping("/save")
   // @RequiresPermissions("mymallmember:umsmemberreceiveaddress:save")
   ...
   // @RequiresPermissions("mymallmember:umsmemberreceiveaddress:update")
   ...
   // @RequiresPermissions("mymallmember:umsmemberreceiveaddress:delete")
