...
import com.zhou.mymall.mymallmember.service.UmsMemberStatisticsInfoService;
 ...
 */
@RestController
@RequestMapping("mymallmember/umsmemberstatisticsinfo")
public class UmsMemberStatisticsInfoController {
     ...
     */
    @RequestMapping("/list")
   // @RequiresPermissions("mymallmember:umsmemberstatisticsinfo:list")
   ...
   // @RequiresPermissions("mymallmember:umsmemberstatisticsinfo:info")
     ...
     */
    @RequestMapping("/save")
   // @RequiresPermissions("mymallmember:umsmemberstatisticsinfo:save")
   ...
   // @RequiresPermissions("mymallmember:umsmemberstatisticsinfo:update")
   ...
   // @RequiresPermissions("mymallmember:umsmemberstatisticsinfo:delete")
